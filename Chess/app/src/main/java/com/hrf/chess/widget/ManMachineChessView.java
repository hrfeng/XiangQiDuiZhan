 ...
 * Date: 2017/8/28
 * Time: 16:17
 * Description: 人机象棋view
 */
public class ManMachineChessView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public ManMachineChessView(Context context) {
        super(context);
        init(context);
    }

    public ManMachineChessView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ManMachineChessView(Context context, AttributeSet attrs, int defStyleAttr) {
